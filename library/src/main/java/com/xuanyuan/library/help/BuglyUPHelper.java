...
public class BuglyUPHelper {
    ...
    //  private static final String APP_ID = "16ccc0aa3f";//智慧秤  测试账号
    private static final String APP_ID = "3bc57bde5d";//智慧秤  上线账号
    private boolean DEBUG_DEVICE = false;// 是否为测试设备, 默认false  不是测试设备

    public static final String APP_PACKAGE_NAME = "com.xuanyuan.library";  // 香山15的渠道号
    public static final String APP_VERSION = "1.0.1";  // 香山15的渠道号
    public static final String APP_CHANNEL = "XS15";  // 香山15的渠道号
// public static final String APP_CHANNEL = "XS8"; // 香山8的渠道号
// public static final String APP_CHANNEL = "AXE"; //  自研秤的渠道号
// public static final String APP_CHANNEL = "SX";  //  深信的渠道号
// public static final String APP_CHANNEL = "ST";  // 商通渠道号

    public BuglyUPHelper(Context context, boolean DEBUG_DEVICE) {
        this.context = context;
        this.DEBUG_DEVICE = DEBUG_DEVICE;
    }
    ...
    public void initBugly(Context context) {
        Bugly.init(context, APP_ID, DEBUG_DEVICE);
        this.context = context.getApplicationContext();
    }

    /* **** Bugly高级设置 ,带渠道的设置*****/
//    strategy.setAppChannel(APP_CHANNEL);
    public void initBugly(BuglyStrategy strategy) {
        Bugly.init(context, APP_ID, DEBUG_DEVICE, strategy);
    }
...
//            buglyUPHelper.setUpgradeListener();
        setUILifecycleListener();
//            buglyUPHelper.setUpgradeStateListener();

        initUpdateConfig();
        initPatch();
        BuglyStrategy strategy = initStrategy();
        initBugly(strategy);
    }

    public BuglyStrategy initStrategy() {
        ...
        strategy.setAppChannel(APP_CHANNEL);
        //TODO 可以挑战设置修改后 测试功能
//        strategy.setAppVersion(APP_VERSION);      //App的版本
//        strategy.setAppPackageName(APP_PACKAGE_NAME);  //App的包名
        return strategy;
    }
...
//                Beta.applyDownloadedPatch();
    ...
    private void initCrash(BuglyStrategy strategy) {
        ...
        CrashReport.setIsDevelopmentDevice(context, DEBUG_DEVICE);
